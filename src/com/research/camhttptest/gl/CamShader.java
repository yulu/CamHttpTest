...
public class CamShader {
	...
	/**
	 * Get id for given handle name. This method checks for both attribute and uniform handles
	 * 
	 * @param name Name of Hanle
	...
	/**
	 * Get array of ids with given name. Returned array is sized to given amount name elements
	 * 
	 * @param name List of handle names
	...
	/**
	 * Compiles vertex adn fragment shaders and links them into a program one 
	 * can use for rendering. Once OpenGL context is lost and onSurfaceCreated is 
	 * called, there is no need to reset existing GlslShader objects but one can simply reload shader
	 * 
